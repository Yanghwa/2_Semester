...
if(empty($user_id) ||empty($first_name) || empty($last_name)) {
    ...
    $_SESSION["fail"] = "Input user id or name";
    $validated = false;
    session_write_close();
...
$sql = 'UPDATE term1_users SET first_name = :first_name, last_name = :last_name, date_of_birth = :date_of_birth,
...
/* HINT: don't forget to exit */
session_write_close();
Echo "Success to update the user";
