...
/**
 * This class defines the membership details and its associated methods for a
 * person/member
 *
...
public class Membership {
	...
	private YearMonth membershipTaken; // the month and year the membership was
										// taken
	 ...
	 * @param join
	 *            the year and month in which membership was taken
	 */
	...
	/**
	 * This method sets the year and month in which the member took the
	 * membership
	 * 
	 * @param joinedIn
	 *            the year and month the membership was taken
	 * 
	 */
	...
	/**
	 * This method returns the month name in which the member took the
	 * membership
	 * 
	...
	public String toString() {
		return String.format("%s (%s) joined in the month %s of %d%n", getMemberName(), getMemberId(), getMonth(),
				getYear());
	}
	 ...
	 * 
	 * @param member
	 *            the membership object that needs to be compared with
	 * @return true, if the two membership objects have the same member id's,
	 *         false otherwise
	 */
	// Code this method
	@Override
	public boolean equals(Object o) {
		Membership exm = (Membership) o;
		if (this.getMemberId().equals(exm.getMemberId())) {
			return true;
		} else
			return false;
		// if(o!=null) {
		// return this.getMemberId().equalsIgnoreCase(exm.getMemberId());
		// } return false;
